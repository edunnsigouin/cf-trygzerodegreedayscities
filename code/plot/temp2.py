...
def style_map(ax):
    """Add publication-style geographic features and gridlines."""
    ax.set_extent(map_extent, crs=ccrs.PlateCarree())

    #ax.add_feature(cfeature.OCEAN, facecolor="0.96", zorder=0)
...
def plot_trend_map(trend, statistic_name, season_name, years):
    ...
    colorbar.set_label(colorbar_label, fontsize=9.5)
